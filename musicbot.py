...
def title(msg):
    ...
    chromedriver_dir = r"C:\Users\Yup_Yiyeon\Desktop\chromedriver.exe"
...
async def on_ready():
    ...
    await bot.change_presence(status=discord.Status.online, activity=discord.Game("CPU오버클럭"))
...
bot.run('ODY2NDkyMjM3NjU4MzI1MDAz.YPTVyA.oZjoQUtbB9lNWz2DFnLX5IUlxfE')
